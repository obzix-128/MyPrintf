...
myPrintfOrig:
    ...
    mov rax, [rel RETURN_VALUE] ; Положили в rax возвращаемое значение
...
default_case:     
    lea rdi, [rel RETURN_VALUE]
    mov rdx, 1
    mov [rdi], rdx ; Положили номер ошибки (скорее варнинг) в возвращаемое значение
    ret                       ; Возвращаемся
...
RETURN_VALUE dq 0 ; Переменная для хранения возвращаемого значения моего принтфа

RETURN_ADDRESS dq 0 ; Переменнмая для сохранения адреса возврата в трамплине
